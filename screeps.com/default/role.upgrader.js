...
var roleUpgrader = {
    ...
    {   
        ...
        if (!creep.memory.carry) {
            return; // Frühzeitige Ausführungsbeendigung, wenn nichts zu tragen.
        }
    ...
    {
        var c = _.filter(Game.creeps, (creep) => creep.memory.role == role && creep.memory.target == spawn.room.name).length;
        var max = maxSpawn;
